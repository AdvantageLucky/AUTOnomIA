...
///
/// Depende de que el dispositivo tenga un servicio de reconocimiento de voz
/// del sistema instalado ("Speech Services by Google" u otro) -- en el F10
/// no venía instalado de fábrica, hay que instalarlo aparte (Play Store).
class AsistenteServicio {
  ...
  /// speech_to_text no necesita liberar ningún recurso por instancia (a
  /// diferencia de Vosk, que exigía un SpeechService compartido) -- se deja
  /// el método para no tener que tocar BotonAsistente.dispose().

...
class ReconocimientoFacialServicio {
  ...
  /// Recorta el rostro con un margen extra (el cuadro de ML Kit suele venir
  /// muy ajustado) y protege contra que el margen se salga de la imagen.
  ...
  /// Convierte la imagen 112x112 a un tensor [1,112,112,3] normalizado a
  /// [-1,1] — mismo esquema de normalización con el que se entrenó/exportó
  /// el modelo MobileFaceNet empaquetado.

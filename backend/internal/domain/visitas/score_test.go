...
func TestScore_DesconocidoQuedaEnLaBase(t *testing.T) {
	sc := AnalizarVisita(nil, Visita{Titular: "Ana"}, EvidenciaEsperada{})
...
func TestScore_RecurrenteLimpioLlegaAAlta(t *testing.T) {
	...
	sc := AnalizarVisita(historialAprobado(6, "ABC123"), nueva,
		EvidenciaEsperada{Rostro: true, Documento: true})
...
func TestScore_VehicularNoSePenalizaPorINEQueNadiePidio(t *testing.T) {
	...
	conINE := AnalizarVisita(historial, nueva, EvidenciaEsperada{Documento: true})
	sinINE := AnalizarVisita(historial, nueva, EvidenciaEsperada{Placa: true})
...
func TestScore_BloqueantesImpidenAutopaseAunqueElScoreAlcance(t *testing.T) {
	...
	sc := AnalizarVisita(historial, nueva, EvidenciaEsperada{Rostro: true, Documento: true})
...
func TestScore_MatchDeRostroSuma(t *testing.T) {
	...
	sinSc := AnalizarVisita(nil, base, EvidenciaEsperada{})
	conSc := AnalizarVisita(nil, conMatch, EvidenciaEsperada{})
...
func TestScore_PlacaDistintaRestaYRecomienda(t *testing.T) {
	...
	sc := AnalizarVisita(historialAprobado(4, "ABC123"), nueva, EvidenciaEsperada{})
...
func TestScore_EvidenciaFaltanteSaleComoRecomendacion(t *testing.T) {
	sc := AnalizarVisita(nil, Visita{Titular: "Ana"}, EvidenciaEsperada{Rostro: true})
...
func TestScore_SiempreEntre0Y100(t *testing.T) {
	...
	sc := AnalizarVisita(historial, pesima, EvidenciaEsperada{Rostro: true, Documento: true, Placa: true})
	...
	sc = AnalizarVisita(historialAprobado(20, "ABC123"), optima, EvidenciaEsperada{})

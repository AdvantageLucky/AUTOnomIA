...
import 'package:kigo_user/core/widgets/kigo_primary_button.dart';
import 'package:kigo_user/core/widgets/kigo_text_field.dart';
import 'package:kigo_user/features/invitar/views/invitacion_creada_detalle_view.dart';
import 'package:kigo_user/features/invitar/views/invitacion_recibida_detalle_view.dart';
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    // Distingue el pase con el que enrolaste a alguien por
                    // rostro (aparece también en "Invitados frecuentes" de
                    // arriba, no es un duplicado por error) de una
                    // invitación normal de un solo uso.
                    if (inv.permiteReconocimientoFacial) ...[
                      ...
                      Container(
                        ...
                        child: Text(
                          AppLocalizations.t(context, 'enrolamiento_badge'),
